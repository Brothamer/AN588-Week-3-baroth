...
```
<!-- PMB: So, your file isn't knitting for me (because I don't have the same path to the saved photo as you), I think if you change the path to get the photo to a link to the one in your Github, then it'll work for the both of us (I think I need to do this too on mine). Also, if you use this code:  ![caption](link to photo) then you can add a photo caption and citation!   -->
...
<!-- PMB: don't forget this is including eight too! -->
...
simulated
```
<!-- PMB: Oh interesting! I never thought to set the seed before this. Why did you chose to do it? So the numbers would stay the same? -->
...
<!-- I think you can still visually compare these graphs because its showing you how many of each mean was chosen in 104 picks (years) -->
...
<!-- Brooke, I think you did an excellent job. It was very easy to follow. Our code looks very similar, if not at some points, the same! I really like how you comment on every line so I can see your train of thought. I also struggled remembering the difference of ppois() and dpois() but found ?ppois() super helpful. I also checked out the link you included! Nice! Also helpful. Question: Why do you want to switch your histogram to show frequency? I think to do this, you might have to do it within the rpois() function not the histogram one, but I'm not positive. I tried to look it up, but couldn't find anything helpful. Maybe you can do it using ggplot when we start using that later on. Anyways, I think the way you are critically analyzing the code is amazing and will allow you to be able to apply it to any future research analysis! Good job!! -Paige-->